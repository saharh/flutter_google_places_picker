...
class GooglePlacesPickerPlugin() : MethodCallHandler, PluginRegistry.ActivityResultListener {
    ...
    fun showAutocompletePicker(mode: Int?, country: String?) {
        val modeToUse = mode ?: 71
        val typeFilterBuilder = AutocompleteFilter.Builder().setTypeFilter(AutocompleteFilter.TYPE_FILTER_ADDRESS)
        if (country != null) {
